...
public interface InventoryService {
    ...
    StageTransition addStageTransition(String fromStageId, String toStageId);
    ...
    Inventory addInventory(String skuId, String unitOfMeasure, String locationId, String stageId);
    // messageId ensures idempotency (duplicate ignored)
    Inventory adjustQuantity(String skuId, String unitOfMeasure, String locationId, String stageId, int quantityChange, String messageId);
    List<Inventory> getInventory(String skuId, String unitOfMeasure);
    List<StorageLocation> getLocationsByType(LocationType type);
    Inventory moveInventory(String skuId, String unitOfMeasure, String fromLocationId, String toLocationId, String stageId, int quantityToMove);
    // messageId ensures idempotency (duplicate ignored)
